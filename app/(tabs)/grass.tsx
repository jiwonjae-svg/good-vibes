...
const styles = StyleSheet.create({
  ...
  todayCard: { marginHorizontal: Spacing.md, marginBottom: Spacing.md, borderRadius: 16, padding: Spacing.lg, ...Shadows.floating },
  ...
  weeklyCard: { marginHorizontal: Spacing.md, marginTop: Spacing.md, marginBottom: Spacing.md, borderRadius: BorderRadius.lg, padding: Spacing.md, ...Shadows.floating },
